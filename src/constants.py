...
DEFAULT_COLUMNS_LIST_RAW = ["lastChar", "inputString", "lastKey", "currentKey", "keyDown", "keyReleased", "keyPressed",\
...
VK_NAMES = {-3:"Mouse1", # Mouse buttons will be put here too in values <0
            -2:"Mouse2",
            -1:"Mouse3",
            0:"", # Represents no key
